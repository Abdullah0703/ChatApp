/**
 * @author K20-1901,K21-3886,K21-3843
 */
package server;
...
public class ServerWithGUI extends javax.swing.JFrame {
                ...
                while ((message = reader.readLine()) != null) {
                    ...
                    if (data[2].equals(connect)) {
                        ...
                        if (recievedID != -1) {
                            ...
                            // //JOptionPane.showMessageDialog(null, "No Name of the online users matches
                            // this name : "+ data[3] +"\n Check the online users correctly ", "This user is
                            // not found or not online", JOptionPane.ERROR_MESSAGE);
                        }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(b_start, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(b_users, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(b_end, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(b_clear, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap()));
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(b_start, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(b_users, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(b_end, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(b_clear, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap()));
    ...
    public void userRemove(String data) {
        ...
        // JOptionPane.showMessageDialog(null, "I am here in top of userremove method
        // server");
        users.remove(name);
        // clientOutputStreams.remove(getid(data));
        // JOptionPane.showMessageDialog(null, "I am here +2 in userremove method
        // server");
    ...
    public void tellthispersononly(String msg, int personid, String recievername) {
        ...
        if (personid == -1) {
            ...
            if (clientOutputStreams.get(personid) != null) {
                ...
                try {
                    PrintWriter writer = clientOutputStreams.get(personid); // clientOutputStreams[personid];
                                                                            // //(PrintWriter) it.next();
                    writer.println(msg);
                    writer.flush();
    ...
    public void tellEveryone(String message) {
        ...
        Iterator it = clientOutputStreams.iterator(); // iterator for looping
